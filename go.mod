module github.com/OreCast/MetaData
...
require (
	...
	github.com/OreCast/common/mongo v0.0.0-20231023133551-89831eb1dae5
...
require (
	github.com/OreCast/common/utils v0.0.0-20231008113920-e5b3f8d8b2d9 // indirect
